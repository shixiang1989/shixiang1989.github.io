...
function (e, t, n) {
    ...
    t.init = function (e, h, v) {
        ...
        t.getColorState = v,
        t.setColorState = function (e, t) {
            (t = t || r).setClearColor(e.clearColor, e.clearAlpha),
...
function (e, t, n) {
    ...
    s.init = function () {
        ...
        s.testViewport = function (e) {
            !e && this.cacheRect || (this.cacheRect = this.refDom.getBoundingClientRect(), this.cacheRectScrollTop = i.scrollTop);
        ...
        if (S = null, e.lang !== r.lang && (window.location.href = e.pathLangPrefix + e.pageUrl), e.aliasInfo) if (t.nextPathInfo = e, e.aliasInfo.isId) t.currPathInfo = t.nextPathInfo,
            ...
            C = i.scrollTo,
                i.showTransition ? i.loadHTML ? (R = !0, r.loader.add(i.loadHTML, {
                    type: "text",
                    onLoad: function (e) {
                        (P = p.createElement(e)).style.display = "none",
...
function (e, t, n) {
    ...
    var c = t.container = null,
        ...
        w = 1;
    function b(e) {
        (f = e.scene.children[0].children[1]).add(e.scene.children[0].children[0]),
...
function (e, t, n) {
    ...
    var i = n(0),
        ...
        o = n(4);
    t.init = function () {
        (s = new i.MeshDepthMaterial).depthPacking = i.RGBADepthPacking,
            s.transparent = !0,
...
function (e, t, n) {
    ...
    var d = l.prototype,
        f = 5;
    function h(e) {
        !this._isActive || this.movableHeight < 1 || (this.isInverted = e.target == this.indicator, this.isDown = !0)
    }
    function v(e, t) {
...
function (e, t, n) {
    ...
    var i;
    function r(e) {
        (i = i || document.createElement("div")).innerHTML = e;
...
function (e, t, n) {
    ...
    v.constructor = f,
        ...
        v.update = function (e, t) {
            if (this.paddingTop = r.height * r.featureOverMaskHeight | 0, this.testViewport(), u.targetDistortion = this.refDomRect.top + 1 < r.height && this.refDomRect.bottom > 1 ? 1 : 0, this.needsRender) {
                !x && r.scrollTopVelocity > 0 && u.playEffect("under_water"),
                    void 0 === g && (g = t),
                    g += .1 * (t - g);
                var n = Math.max(0, g),
                    i = _.length,
...
function (e, t, n) {
    ...
    t.init = function () {
        (s = t.geom = t.geom || new i.BufferGeometry).setAttribute("position", new i.BufferAttribute(new Float32Array([- 1, -1, 0, 4, -1, 0, -1, 4, 0]), 3)),
...
function (e, t, n) {
    ...
    v.constructor = f,
        v.preInit = function () {
            if (h.preInit.call(this), l.preInit(this), !r.isMobile) {
                (p = new i.Texture(a.loader.add(o.cdnPath + "visuals/homeAbout/beethoven.png").content)).flipY = !1,
                ...
                a.loader.add(o.assetPath + "visuals/homeAbout/beethoven.glb", {
                    ...
                    loadFunc: function (t, n, i) {
                        a.GLTFLoader.load(t,
                            function (t) {
                                (m = t.scene.children[0]).position.x = 0,
...
function (e, t, n) {
    ...
    t.preInit = function (e) {
        ...
        t.init = function () {
            (l = new a).clearColor = c.backgroundColor,
        ...
        v = e,
            ...
            o.loader.add(r.assetPath + "images/animation.glb", {
                ...
                loadFunc: function (e, t, n) {
                    o.GLTFLoader.load(e,
                        function (e) {
                            (l = e.scene.children[0].children[1]).add(e.scene.children[0].children[0]),
                    ...
                    for (var i = n[0], o = n[1], a = n[2], s = n[3], u = n[4], c = [], l = 0, d = i.length; l < d; l++) {
                        ...
                        if (void 0 !== f) {
                            ...
                            var _ = f.name ? f.name : f.uuid,
                                ...
                                w = [];
                            C[g.path] === C.weights ? f.traverse(function (e) {
