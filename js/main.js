...
const add_id = "w8js8jrczuerthsp"; // app_id
const app_secret = "YUF6Ulpkd2hpZHB6UkFjVWt3RHZMUT09"; // app_secret
const key = "561d05cebece454aa7c2f5a78a64a478" // key
function getWeather() {
...
$("#qq").mouseover(function () {
    $("#link-text").html("有什么事吗,暂时不可用哦");
}).mouseout(function () {
    $("#link-text").html("通过这里联系我");
});
$("#email").mouseover(function () {
    $("#link-text").html("来封 Email,暂时不可用");
}).mouseout(function () {
    $("#link-text").html("通过这里联系我");
});
